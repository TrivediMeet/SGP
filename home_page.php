...
<body>
    <header>
        ...
        <h1 style="align-self: center;">Welcome To Aashirvad Hostel (The Second home) </h1>
...
<section class="team-section" id="Au">
    ...
    <div class="team-member">
        <div class="member-info">
            <h3>Umesh Kunvariya</h3>
            <p>Email: 22AIML057@charusat.edu.in</p>
            <p>Contact: 8758059160</p>
        </div>
    ...
    <div class="team-member">
        <div class="member-info">
            <h3>Vivek Solanki</h3>
            <p>Email: 22AIML052@charusat.edu.in</p>
            <p>Contact: 6353162997 </p>
        </div>
        <!-- <p class="member-description">
